...
public sealed class OpenIncidentHandler : IRequestHandler<OpenIncidentCommand>
{
    ...
    public async Task Handle(OpenIncidentCommand request, CancellationToken cancellationToken)
    {
        ...
        incident.Open(_modificationContext, _lifecyclePolicy);
