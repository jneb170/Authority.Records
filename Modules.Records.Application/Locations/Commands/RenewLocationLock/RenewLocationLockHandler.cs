...
public sealed class RenewLocationLockHandler : IRequestHandler<RenewLocationLockCommand>
{
    private readonly IApplicationDbContext _dbContext;
    private readonly ITenantProvider _tenantProvider;
    private readonly IModificationContext _modificationContext;

    public RenewLocationLockHandler(
    ...
    public async Task Handle(RenewLocationLockCommand request, CancellationToken cancellationToken)
    {
        ...
        location.RenewLock(_modificationContext);
