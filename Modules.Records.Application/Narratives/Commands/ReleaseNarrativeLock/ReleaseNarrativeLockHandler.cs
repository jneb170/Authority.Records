...
public sealed class ReleaseNarrativeLockHandler : IRequestHandler<ReleaseNarrativeLockCommand>
{
    private readonly IApplicationDbContext _dbContext;
    private readonly ITenantProvider _tenantProvider;
    private readonly IModificationContext _modificationContext;

    public ReleaseNarrativeLockHandler(
    ...
    public async Task Handle(ReleaseNarrativeLockCommand request, CancellationToken cancellationToken)
    {
        ...
        narrative.ReleaseLock(_modificationContext);
