...
public sealed class CitationNameSnapshot : AggregateRoot, IMultiTenant
{
    ...
    private CitationNameSnapshot()
    {
    }

    private CitationNameSnapshot(Guid jurisdictionId, Guid agencyId, Guid citationId)
    {
        Id = Guid.NewGuid();
    ...
    public static CitationNameSnapshot Create(
        Guid jurisdictionId,
        Guid agencyId,
        Guid citationId,
        Guid? sourceNameId,
        ...
        Guid copiedByUserId)
    {
        var snapshot = new CitationNameSnapshot(jurisdictionId, agencyId, citationId);
