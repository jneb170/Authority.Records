...
WHERE EXISTS (SELECT 1 FROM CitationOffenseDetails o WHERE o.CitationId = CitationTexasDetails.CitationId);";
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourceChargeLinkId = table.Column<Guid>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
        ...
        {
            migrationBuilder.AddColumn<string>(name: "AcceptedBondNotes", table: "CitationTexasDetails", type: "TEXT", maxLength: 500, nullable: true);
            migrationBuilder.AddColumn<DateTime>(name: "AffidavitSignedDate", table: "CitationTexasDetails", type: "TEXT", nullable: true);
            migrationBuilder.AddColumn<string>(name: "ComplainantSignatureText", table: "CitationTexasDetails", type: "TEXT", maxLength: 150, nullable: true);
            migrationBuilder.AddColumn<DateTime>(name: "CourtAppearanceDateTime", table: "CitationTexasDetails", type: "TEXT", nullable: true);
            migrationBuilder.AddColumn<Guid>(name: "CourtAppearanceLocationId", table: "CitationTexasDetails", type: "TEXT", nullable: true);
            migrationBuilder.AddColumn<string>(name: "DefendantSignatureText", table: "CitationTexasDetails", type: "TEXT", maxLength: 150, nullable: true);
            migrationBuilder.AddColumn<string>(name: "NarrativeOtherViolations", table: "CitationTexasDetails", type: "TEXT", maxLength: 1000, nullable: true);
            migrationBuilder.AddColumn<string>(name: "OccurredAtText", table: "CitationTexasDetails", type: "TEXT", maxLength: 250, nullable: true);
            migrationBuilder.AddColumn<string>(name: "PrimaryViolationDescription", table: "CitationTexasDetails", type: "TEXT", maxLength: 250, nullable: true);
            migrationBuilder.AddColumn<string>(name: "ReceiptNumber", table: "CitationTexasDetails", type: "TEXT", maxLength: 50, nullable: true);
            migrationBuilder.AddColumn<Guid>(name: "SpeedBandId", table: "CitationTexasDetails", type: "TEXT", nullable: true);
            migrationBuilder.AddColumn<int>(name: "SpeedMph", table: "CitationTexasDetails", type: "INTEGER", nullable: true);
            migrationBuilder.AddColumn<Guid>(name: "ViolationGroupId", table: "CitationTexasDetails", type: "TEXT", nullable: true);
            migrationBuilder.AddColumn<string>(name: "ViolationSection", table: "CitationTexasDetails", type: "TEXT", maxLength: 50, nullable: true);
            migrationBuilder.AddColumn<Guid>(name: "ViolationSourceTypeId", table: "CitationTexasDetails", type: "TEXT", nullable: true);
            migrationBuilder.AddColumn<int>(name: "ZoneMph", table: "CitationTexasDetails", type: "INTEGER", nullable: true);
