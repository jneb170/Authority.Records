...
internal sealed class CitationNameSnapshotConfiguration : IEntityTypeConfiguration<CitationNameSnapshot>
{
    public void Configure(EntityTypeBuilder<CitationNameSnapshot> builder)
    {
        ...
        builder.HasOne<Citation>()
            .WithOne()
            .HasForeignKey<CitationNameSnapshot>(x => x.CitationId)
